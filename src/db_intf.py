...
log = logging.getLogger('gmt.db_intf')
    ...
    def create_structures(self):
        try:
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS masternodes(id INTEGER PRIMARY KEY, ident TEXT, status TEXT,"
                        ...
                        " gmt_active INTEGER, gmt_create_time TEXT, gmt_deactivation_time TEXT)")

            cur.execute("CREATE INDEX IF NOT EXISTS IDX_masternodes_GMT_ACTIVE ON masternodes(gmt_active)")
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS proposals(id INTEGER PRIMARY KEY, name TEXT, payment_start TEXT,"
                        ...
                        " f_cached_endorsed INTEGER, object_type INTEGER, is_valid_reason TEXT, gmt_active INTEGER, "
                        " gmt_create_time TEXT, gmt_deactivation_time TEXT, gmt_voting_last_read_time INTEGER,"
            ...
            # has just been sent from gmt wallet or the transaction which appeared in the mempool); in this case
