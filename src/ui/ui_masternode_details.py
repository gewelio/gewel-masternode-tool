...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        self.lblGMNTxHash = QtWidgets.QLabel(self.widget_2)
        self.lblGMNTxHash.setMinimumSize(QtCore.QSize(144, 0))
        self.lblGMNTxHash.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lblGMNTxHash.setObjectName("lblGMNTxHash")
        self.horizontalLayout_10.addWidget(self.lblGMNTxHash)
        self.edtGMNTxHash = QtWidgets.QLineEdit(self.widget_2)
        self.edtGMNTxHash.setClearButtonEnabled(True)
        self.edtGMNTxHash.setObjectName("edtGMNTxHash")
        self.horizontalLayout_10.addWidget(self.edtGMNTxHash)
        self.btnFindGMNTxHash = QtWidgets.QToolButton(self.widget_2)
        self.btnFindGMNTxHash.setObjectName("btnFindGMNTxHash")
        self.horizontalLayout_10.addWidget(self.btnFindGMNTxHash)
        ...
        WdgMasternodeDetails.setTabOrder(self.edtCollateralTxIndex, self.edtGMNTxHash)
        WdgMasternodeDetails.setTabOrder(self.edtGMNTxHash, self.edtMasternodePrivateKey)
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.btnShowCollateralPathAddress.setToolTip(_translate("WdgMasternodeDetails", "Show Gewel address for the entered BIP32 path"))
        ...
        self.lblGMNTxHash.setText(_translate("WdgMasternodeDetails", "GMN TX hash"))
        self.btnFindGMNTxHash.setToolTip(_translate("WdgMasternodeDetails", "Find GMN TX hash based on the ip/port or collateral tx"))
        self.btnFindGMNTxHash.setText(_translate("WdgMasternodeDetails", "Find"))
