...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabGeweld = QtWidgets.QWidget()
        self.tabGeweld.setObjectName("tabGeweld")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabGeweld)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabGeweld)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboGewelNetwork = QtWidgets.QComboBox(self.tabGeweld)
        self.cboGewelNetwork.setObjectName("cboGewelNetwork")
        self.cboGewelNetwork.addItem("")
        self.cboGewelNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboGewelNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabGeweld)
        ...
        self.tabWidget.addTab(self.tabGeweld, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Gewel network:"))
        self.cboGewelNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboGewelNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGeweld), _translate("ConfigDlg", "Gewel network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (GewelCentral.org)"))
