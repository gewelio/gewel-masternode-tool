...
APP_NAME_SHORT = 'GewelMasternodeTool'
APP_NAME_LONG = 'Gewel Masternode Tool'
APP_DATA_DIR_NAME = '.gmt'
PROJECT_URL = 'https://github.com/gewelio/gewel-masternode-tool'
FEE_ADAM_PER_BYTE = 1
MIN_TX_FEE = 1000
...
def get_note_url(note_symbol):
    ...
    :param note_symbol: Symbol of the note, for example: GMT00001
    :return: URL
    """
...
__KNOWN_LOGGERS = [
    KnownLoggerType(name='gmt.wallet_dlg', external=False),
    KnownLoggerType(name='gmt.bip44_wallet', external=False),
    KnownLoggerType(name='gmt.geweld_intf', external=False),
    KnownLoggerType(name='gmt.db_intf', external=False),
    KnownLoggerType(name='gmt.proposals', external=False),
    KnownLoggerType(name='gmt.ext_item_model', external=False),
    KnownLoggerType(name='gmt.hw_intf_trezor', external=False),
    KnownLoggerType(name='gmt.reg_masternode', external=False),
    KnownLoggerType(name='gmt.transaction_dlg', external=False),
    KnownLoggerType(name='gmt.app_cache', external=False),
