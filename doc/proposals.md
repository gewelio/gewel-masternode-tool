 ...
 *GMT* includes functionality for *masternode owners* (MNOs) to review and cast votes on current proposals. In addition to MNOs, this feature is also useful to *proposal owners*, who can use it to track and analyze voting progress on their proposals.
...
![Proposals window](img/gmt-proposals-window.png)
...
![Column selection dialog](img/gmt-proposals-columns.png)
 ...
 * Cast a vote on proposals (if a masternode is configured in *GMT*).
 ...
 * A chart summarizing YES, NO and ABSTAIN vote counts.  
    ![Voting history tab](img/gmt-proposals-voting-history.png)  

    Vote change chart:  
    ![Vote change chart](img/gmt-proposals-vote-change-chart.png)  

    Vote summary chart:  
    ![Vote summary chart](img/gmt-proposals-vote-summary-chart.png)

### Casting votes

In the main proposals list, select the proposal(s), you'd like to vote on.

> Note: You can select and vote on multiple proposals
...
![Vote tab](img/gmt-proposals-vote.png)
...
![Vote tab](img/gmt-proposals-vote-2.png)
