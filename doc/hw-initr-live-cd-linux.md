...
2. On the running Linux system, download the latest [Gewel Masternode Tool archived binary](https://github.com/gewelio/gewel-masternode-tool/releases) (.tar.gz) from the project page, or copy the file to the system in some other way.
...
**A copy of the commands to create the udev rules required by hardware wallets supported by GMT appears below**
